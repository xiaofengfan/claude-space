...
const electronAPI = {
  ...
  loopUpdate: (opts: { id: string; name?: string; prompt?: string; interval?: string; enabled?: boolean }) => ipcRenderer.invoke('loop:update', opts),
  loopPause: (id: string) => ipcRenderer.invoke('loop:pause', id),
